          ...
          <Box>
            ...
            >
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                >
                  {valProfile?.identity
                    ? valProfile._identity
                    : stashDisplay(chainAddress(address, chainInfo.ss58Format))}
                </Typography>
                <Typography
                  variant="caption"
                  color={
