...
import { modeChanged } from "../features/layout/layoutSlice";
import {
  ...
  return (
    <Box component="span">
      ...
      >
        ...
        <ListItemText
          primary="Validator Insights"
          sx={{ "> .MuiTypography-root": { fontSize: "0.875rem" } }}
        />
      </ListItemButton>

      <ListItemButton
        selected={selectedPage === "parachains"}
        disableRipple
      ...
      <ListItemButton
        selected={selectedPage === "val-groups"}
        disableRipple
  ...
  return (
    <Box component="span">
      ...
      {selectedChain === "kusama" ? (
        ...
        >
          <ListItemIcon
            sx={{ ml: theme.spacing(-1 / 2), py: theme.spacing(2) }}
          >
            <img
