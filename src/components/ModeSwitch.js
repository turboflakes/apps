...
const MaterialUISwitch = styled(Switch)(({ checked, theme }) => ({
  width: 62,
  height: 34,
  padding: 7,
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& .MuiSwitch-thumb:before': {
        backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24"><circle fill="${encodeURIComponent(
            '#44D7B6',
          )}" cx="12" cy="12" r="8"/></svg>')`,
