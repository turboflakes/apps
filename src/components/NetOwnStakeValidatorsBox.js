      ...
      >
        ...
        <Box sx={{ minWidth: "192px" }}>
          <Typography component="div" variant="caption">
            ...
            ALL:{" "}
            <b>{stakeDisplay(data.total, chainInfo, 4, true, true, true)}</b> (
          ...
          {/* <Typography component="div" variant="caption">
            ...
            DN: <b>{stakeDisplay(data.tvp, chainInfo, 4, true, true, true)}</b>{" "}
          ...
          <Typography component="div" variant="caption">
            ...
            100% Com.:{" "}
            <b>{stakeDisplay(data.c100, chainInfo, 4, true, true, true)}</b> (
          ...
          <Typography component="div" variant="caption">
            ...
            Others:{" "}
            <b>{stakeDisplay(data.others, chainInfo, 4, true, true, true)}</b> (
...
export default function NetOwnStakeValidatorsBox({
  sessionIndex,
  maxSessions,
}) {
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between" }}>
        ...
        >
          <Typography variant="caption" gutterBottom>
            Total <b>Validators Own Stake</b> by the end of the previous epoch
          </Typography>
          <Typography
            variant="h4"
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip
              ...
              content={(props) =>
                renderTooltip(props, theme, selectedChainInfo)
              }
            />
