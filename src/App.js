...
import { useGetPkgQuery } from "./features/api/apiSlice";
...
const App = () => {
  ...
  const matches = useMediaQuery(
    selectedApp === "onet" ? "(max-width: 1440px)" : "(max-width: 1024px)",
  );
        ...
        >
          {selectedApp === "onet" ? (
            <React.Fragment>
              ...
              <Typography variant="h6" color="secondary" align="center">
                Reach a BIGGER screen to get full experience :)
              </Typography>
              <Typography variant="caption" color="secondary" align="center">
                ONE-T is currently optimized for screens with a width of 1440
                pixels or greater.
              </Typography>
            </React.Fragment>
          ) : null}
          {selectedApp === "nomi" ? (
            <React.Fragment>
              ...
              <Typography variant="caption" color="secondary" align="center">
                NOMI is currently optimized for screens with a width of 1024
                pixels or greater.
              </Typography>
            </React.Fragment>
          ) : null}
