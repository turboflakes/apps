...
export const chainLogos = Object.entries({
  'Ajuna Network': nodeAjuna,
  'Aleph Zero': chainAleph,
  'Aleph Zero Network': chainAleph,
  Altair: chainAltair,
  'Apron PC1': nodeApron,
  Arctic: nodeArctic,
  ...
  'Bifrost Stage Network': nodeBifrost,
  ...
  'Calamari Parachain Network': nodeCalamari,
  'Catalyst Network': nodeCentrifuge,
  Centrifuge: nodeCentrifuge,
  ChainX: nodeChainx,
  'Charcoal Network': nodeCentrifuge,
  ...
  'Creditcoin Network': chainCreditcoinTest,
  ...
  'DataHighway Spreehafen Rococo Parachain Network': chainRoccoDataHighway,
  'DataHighway Tanganika Kusama Parachain': chainKusamaDataHighway,
  'Dolphin Network': nodeDolphin,
  ...
  'Genshiro Rococo Network': chainGenshiro,
  ...
  'InvArch Brainstorm Network': chainBrainstorm,
  ...
  'Manta Parachain Network': nodeManta,
  Mars: nodeAresMars,
  MathChain: nodeMath,
  'MathChain PC1': nodeMath,
  'mathchain-galois': nodeMath,
  Minix: nodeMinix,
  'Minix Network': nodeMinix,
  'Moonbase Alpha': moonbase,
  'Moonbase Development Network': moonbase,
  ...
  'Pichiu': nodePichiu,
  'Pichiu Network': nodePichiu,
  'Pioneer Network': nodePioneerNetwork,
  'Polkadex Mainnet': nodePolkadex,
  'Polkadex Network': nodePolkadex,
  'PolkaFoundry PC1': nodePolkaFoundry,
  'Pontem Network': nodePontem,
  'Prism Network': nodePrism,
  'Prism PC1': nodePrism,
...
export const nodeLogos = Object.entries({
  ...
  'Opportunity Standalone Network': nodeOpportunity,
  Pangolin: nodePangolin,
  Pangoro: nodePangoro,
